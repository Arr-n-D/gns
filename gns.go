...
// #cgo !gns_static LDFLAGS: -lGameNetworkingSockets                                               -L${SRCDIR}/lib/GameNetworkingSockets/build/bin
// #cgo  gns_static,!windows LDFLAGS: -lGameNetworkingSockets_s -lssl -lcrypto -lprotobuf          -L${SRCDIR}/lib/GameNetworkingSockets/build/bin
// #cgo  gns_static,windows  LDFLAGS: -lGameNetworkingSockets_s -lssl -lcrypto -lprotobuf -lws2_32 -L${SRCDIR}/lib/GameNetworkingSockets/build/bin
/*
	#include <gns.h>
